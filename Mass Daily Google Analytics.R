...
paramsTraffic <- Init(start.date = "2015-06-01", end.date = enddate,
...
paramsEvents <- Init(start.date = "2015-06-01", end.date = enddate,
...
write.csv(ga_traffic, file = "ga_traffic_data.csv", row.names = FALSE)
write.csv(ga_events, file = "ga_events_data.csv", row.names = FALSE)
