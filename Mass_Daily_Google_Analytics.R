...
paramsTraffic <- Init(start.date = "2016-01-01", end.date = "2017-01-06",
...
paramsEvents <- Init(start.date = "2016-01-01", end.date = "2017-01-06",
...
paramsMobile <- Init(start.date = "2016-05-20", end.date = "2017-01-06",
                     dimensions = c("ga:date", "ga:dimension2"),
                     metrics = c("ga:sessions", "ga:avgSessionDuration"), 
...
##Create GA_Events_Mobile
paramsEventsMobile <- Init(start.date = "2016-08-17", end.date = "2017-01-06",
                           dimensions = c("ga:date", "ga:dimension2", "ga:dimension19", "ga:dimension13"),
                           metrics = c("ga:totalEvents", "ga:eventValue"), 
                           table.id = "ga:120621676",
                           sort = "ga:dimension2",
